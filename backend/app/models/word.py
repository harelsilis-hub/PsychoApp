...
class Word(Base):
    ...
    Attributes:
        ...
        hebrew: Hebrew word.
        difficulty_rank: Difficulty ranking (1-100, indexed for binary search).
    ...
    difficulty_rank: Mapped[int] = mapped_column(Integer, index=True, nullable=False)
    ...
    def __repr__(self) -> str:
        return f"<Word(id={self.id}, english='{self.english}', hebrew='{self.hebrew}', rank={self.difficulty_rank})>"
